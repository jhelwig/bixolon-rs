# Task 20: Public API and Documentation

> **Context:** See [index.md](./index.md) for architecture and rationale

**Files:**
- Modify: `src/lib.rs` (add public re-exports, documentation)

---

## Goals

1. Clean public API surface with organized re-exports
2. Crate-level documentation with examples
...
pub use style::{StyleSet, text::StyledNode};
...
```bash
git add src/lib.rs
git commit -m "feat: add public API re-exports and crate documentation"
```
